...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    private ItemModelBuilder layeredFloppyModel(RegistryObject<Item> itemObject) {
    ...
    public static ResourceLocation materialTexture(String modId, String color) {
        return new ResourceLocation(modId, "item/floppy/" + color + "_floppy_base");
    }

    public static ResourceLocation overlayTexture(String modId, String tier) {
        return new ResourceLocation(modId, "item/floppy/" + tier + "_floppy_tier");
    }
    ...
    private void generateTerrabladeModels() {
        ...
        for (int i = 1; i <= 14; i++) {
            ...
            step.customLoader(SeparateTransformsModelBuilder::begin)
                    .base(getParentModel(
                            new ResourceLocation(ByteBuddies.MOD_ID, "item/_inline/step_" + i + "/base"),
                            new ResourceLocation(ByteBuddies.MOD_ID, "item/terrablade_held_charge_" + i))
                    )

                    .perspective(ItemDisplayContext.GUI, getItemModel(
                            new ResourceLocation(ByteBuddies.MOD_ID, "item/_inline/step_" + i + "/gui"),
                            new ResourceLocation(ByteBuddies.MOD_ID, "item/terrablade_item"))
                    )
                    .perspective(ItemDisplayContext.GROUND, getItemModel(
                            new ResourceLocation(ByteBuddies.MOD_ID, "item/_inline/step_" + i + "/ground"),
                            new ResourceLocation(ByteBuddies.MOD_ID, "item/terrablade_item"))
                    )
                    .perspective(ItemDisplayContext.FIXED, getItemModel(
                            new ResourceLocation(ByteBuddies.MOD_ID, "item/_inline/step_" + i + "/fixed"),
                            new ResourceLocation(ByteBuddies.MOD_ID, "item/terrablade_item"))
                    )
                    .end();
        }
        ...
        top.customLoader(SeparateTransformsModelBuilder::begin)
                .base(getParentModel(
                        new ResourceLocation(ByteBuddies.MOD_ID, "item/_inline/top/base"),
                        new ResourceLocation(ByteBuddies.MOD_ID, "item/terrablade_held"))
                )

                .perspective(ItemDisplayContext.GUI, getItemModel(
                        new ResourceLocation(ByteBuddies.MOD_ID, "item/_inline/top/gui"),
                        new ResourceLocation(ByteBuddies.MOD_ID, "item/terrablade_item"))
                )
                .perspective(ItemDisplayContext.GROUND, getItemModel(
                        new ResourceLocation(ByteBuddies.MOD_ID, "item/_inline/top/ground"),
                        new ResourceLocation(ByteBuddies.MOD_ID, "item/terrablade_item"))
                )
                .perspective(ItemDisplayContext.FIXED, getItemModel(
                        new ResourceLocation(ByteBuddies.MOD_ID, "item/_inline/top/fixed"),
                        new ResourceLocation(ByteBuddies.MOD_ID, "item/terrablade_item"))
                )
                .end();
    ...
    private ItemModelBuilder getItemModel(ResourceLocation itemModel, ResourceLocation itemTexture) {
        ...
        itemModelBuilder.parent(new ModelFile.UncheckedModelFile(new ResourceLocation("item/generated")));
