...
public class BatteryItem extends Item {
    ...
    public void setEnergy(ItemStack batteryStack, int energyValue) {
        ...
        CompoundTag nbtData = batteryStack.getOrCreateTag();
    ...
    public void appendHoverText(ItemStack pStack, @Nullable Level pLevel, List<Component> pTooltipComponents, TooltipFlag pIsAdvanced) {
        ...
        pTooltipComponents.add(Component.literal(batteryTier() + " Capacity: " + capacity + " FE").withStyle(ChatFormatting.GRAY));
        pTooltipComponents.add(Component.literal("Charge: " + getEnergy(pStack) + " FE").withStyle(ChatFormatting.DARK_AQUA));
        pTooltipComponents.add(Component.literal("I/O per use: " + ioRate + " FE").withStyle(ChatFormatting.DARK_AQUA));
    }
