...
public class GoalUtil {
    ...
    public static void renewClaimIfNeeded(
            ByteBuddyEntity byteBuddy, ServerLevel serverLevel, TaskType taskType, @Nullable BlockPos claimedPos,
    ...
    public static boolean canPlantAt(Level level, BlockPos blockPos, BlockState plantState) {
        ...
        if (!(plantState.getBlock() instanceof IPlantable plantable)) {
            return false;
        }
