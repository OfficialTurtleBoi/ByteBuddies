...
public class SwordSweepRenderer extends EntityRenderer<SwordSweepEntity> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(ByteBuddies.MOD_ID, "textures/entity/terrablade_sweep.png");
    ...
    private void drawQuad(PoseStack poseStack, VertexConsumer vertexConsumer, int vertexAlpha) {
        ...
        vertex(vertexConsumer, matrix, normalMatrix, -halfWidth, -halfHeight, 0, 0, 0, 255, 255, 255, vertexAlpha);
        vertex(vertexConsumer, matrix, normalMatrix, halfWidth, -halfHeight, 0, 1, 0, 255, 255, 255, vertexAlpha);
        vertex(vertexConsumer, matrix, normalMatrix, halfWidth, halfHeight, 0, 1, 1, 255, 255, 255, vertexAlpha);
        vertex(vertexConsumer, matrix, normalMatrix, -halfWidth, halfHeight, 0, 0, 1, 255, 255, 255, vertexAlpha);
