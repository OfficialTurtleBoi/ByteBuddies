...
public class ByteBuddyRenderer extends MobRenderer<ByteBuddyEntity, ByteBuddyModel<ByteBuddyEntity>> {
    private static final ResourceLocation DEFAULT_TEXTURE =
            new ResourceLocation(ByteBuddies.MOD_ID, "textures/entity/bytebuddy/bytebuddy.png");
    private static final ResourceLocation IRON_TEXTURE =
            new ResourceLocation(ByteBuddies.MOD_ID, "textures/entity/bytebuddy/bytebuddy_iron.png");
    private static final ResourceLocation STEEL_TEXTURE =
            new ResourceLocation(ByteBuddies.MOD_ID, "textures/entity/bytebuddy/bytebuddy_steel.png");
    private static final ResourceLocation NETHERITE_TEXTURE =
            new ResourceLocation(ByteBuddies.MOD_ID, "textures/entity/bytebuddy/bytebuddy_netherite.png");
    private static final ResourceLocation CHARGED_STEEL_TEXTURE =
            new ResourceLocation(ByteBuddies.MOD_ID, "textures/entity/bytebuddy/bytebuddy_charged_steel.png");
    private static final ResourceLocation DISPLAY =
            new ResourceLocation(ByteBuddies.MOD_ID, "textures/entity/bytebuddy/bytebuddycore.png");
    ...
    private static class DisplayLayer extends RenderLayer<ByteBuddyEntity, ByteBuddyModel<ByteBuddyEntity>> {
        ...
        public void render(@NotNull PoseStack pose, MultiBufferSource buffers, int packedLight,
            ...
            // bottom-left
            faceBuf.vertex(mat, x1, y1, z)
                    .color(r, g, b, a)
                    .uv(u1, v1)
                    .overlayCoords(OverlayTexture.NO_OVERLAY)
                    .uv2(packedLight)
                    .normal(normalMat, 0f, 0f, -1f)
                    .endVertex();

            // top-left
            faceBuf.vertex(mat, x1, y2, z)
                    .color(r, g, b, a)
                    .uv(u1, v2)
                    .overlayCoords(OverlayTexture.NO_OVERLAY)
                    .uv2(packedLight)
