...
public final class ModTags {
    public static final class Blocks {
        ...
        private static TagKey<Block> createTag(String name){
            return BlockTags.create(new ResourceLocation(ByteBuddies.MOD_ID, name));
        }
    }
    ...
    public static final class Items {
        ...
        public static final TagKey<Item> STORAGE_CELL = createTag("storage_cell");

        private static TagKey<Item> createTag(String name){
            return ItemTags.create(new ResourceLocation(ByteBuddies.MOD_ID, name));
        }
    }
}
