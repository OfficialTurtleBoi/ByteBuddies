...
public enum ModTiers implements Tier {
    BUSTER(2, 1170, 8.0f, 3.0f, 12, BlockTags.NEEDS_DIAMOND_TOOL, () -> Ingredient.of(ModItems.STEEL_INGOT.get())),
    TERRABLADE(3, 1523, 8.5f, 3.5f, 18, BlockTags.NEEDS_DIAMOND_TOOL, () -> Ingredient.of(ModItems.CHARGED_STEEL_INGOT.get()));
