...
public class ByteBuddyDoubleScreen extends AbstractBuddyScreen<ByteBuddyDoubleMenu> {
    ...
    public ByteBuddyDoubleScreen(ByteBuddyDoubleMenu menu, Inventory inventory, Component title) {
